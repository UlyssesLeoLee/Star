...
//! **数据设计**: docs/data-design.md §4.18 (`integration` schema)
//! **API 设计**: docs/api-design.md §3.21 (Integration / SyncState)
//!
//! ## 职责
//!
...
//! ## 关键引用
//!
//! Link/Mirror/Bidirectional/Platform-owned 4 模式(§18.1)
...
/// Integration (聚合根 / 实体)
///
/// 来源: docs/data-design.md §4.18 (`integration` schema)
///
...
/// **IntegrationCommandPort**(命令端口)
///
/// 来源: docs/api-design.md §3.21 (Integration / SyncState)
///
...
/// Domain Event: `star.events.integration.sync.started.v1`
///
/// 来源: docs/api-design.md §5 (CloudEvents 1.0)
///
/// **骨架阶段**: 仅占位字段,Phase 2 补充完整 Payload 字段。
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Integration01Event {
    /// 事件唯一 ID(UUIDv7)
    pub event_id: Uuid,
    /// 租户 ID(必带)
    pub tenant_id: Uuid,
...
/// Domain Event: `star.events.integration.sync.completed.v1`
///
/// 来源: docs/api-design.md §5 (CloudEvents 1.0)
///
/// **骨架阶段**: 仅占位字段,Phase 2 补充完整 Payload 字段。
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Integration02Event {
    /// 事件唯一 ID(UUIDv7)
    pub event_id: Uuid,
    /// 租户 ID(必带)
    pub tenant_id: Uuid,
