...
//!
//! **crate**: `domain-scm`
//! **上游 spec**: docs/specs/domain-scm-spec.md §18-19 SCM Integration
//! **基本设计**: docs/basic-design.md §2.1 / §4.7 / §4.8
//! **数据设计**: docs/data-design.md §4.8 (`scm` schema)
//! **API 设计**: docs/api-design.md §3.11 (Repository / Branch / Commit / PR)
//!
//! ## 职责
//!
...
/// Repository (聚合根 / 实体)
///
/// 来源: docs/data-design.md §4.8 (`scm` schema)
///
...
/// **ScmCommandPort**(命令端口)
///
/// 来源: docs/api-design.md §3.11 (Repository / Branch / Commit / PR)
///
...
/// Domain Event: `star.events.scm.repository.synced.v1`
///
/// 来源: docs/api-design.md §5 (CloudEvents 1.0)
///
/// **骨架阶段**: 仅占位字段,Phase 2 补充完整 Payload 字段。
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Scm02Event {
    /// 事件唯一 ID(UUIDv7)
    pub event_id: Uuid,
    /// 租户 ID(必带)
    pub tenant_id: Uuid,
...
/// Domain Event: `star.events.scm.pull_request.opened.v1`
///
/// 来源: docs/api-design.md §5 (CloudEvents 1.0)
///
/// **骨架阶段**: 仅占位字段,Phase 2 补充完整 Payload 字段。
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Scm03Event {
    /// 事件唯一 ID(UUIDv7)
    pub event_id: Uuid,
    /// 租户 ID(必带)
    pub tenant_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RecordPipelineRunCommand {
    /// 主键 UUID
    pub id: Uuid,
    /// 租户 ID(13 类对象必带,§6.1)
    pub tenant_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpsertBranchCommand {
    /// 主键 UUID
    pub id: Uuid,
    /// 租户 ID(13 类对象必带,§6.1)
    pub tenant_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpsertPullRequestCommand {
    /// 主键 UUID
    pub id: Uuid,
    /// 租户 ID(13 类对象必带,§6.1)
    pub tenant_id: Uuid,
