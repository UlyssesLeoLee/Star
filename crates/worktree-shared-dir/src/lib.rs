...
//! - 3 Source: `PerUserSource` + `WorkspaceSource` (PG, P1 followup) + `ConfigSource` (file-backed, 实装 in-crate)
...
pub use shared_dir_resolver::{
    ...
    NoopConfigSource, NoopPerUserSource, NoopWorkspaceSource, PerUserSource, ResolvedSharedDirs,
    SharedDirResolver, WorkspaceSource, CLI_CONFIG_DIR_NAME, CLI_CONFIG_FIELD,
