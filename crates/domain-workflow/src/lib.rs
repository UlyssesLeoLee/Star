...
//! **上游 spec**: docs/specs/domain-workflow-spec.md §9 Workflow 状态机
//! **基本设计**: docs/basic-design.md §2.1 / §4.9.3 / §7.6
//! **数据设计**: docs/data-design.md §4.10 (`workflow` schema)
//! **API 设计**: docs/api-design.md §3.13 (Workflow Definition + Transition)
//!
//! ## 职责
//!
...
//! ## 关键引用
//!
//! WorkItem 默认三态由本 crate WorkflowDefinition 判定(§4.9.3,INV-WI-09)
...
/// WorkflowDefinition (聚合根 / 实体)
///
/// 来源: docs/data-design.md §4.10 (`workflow` schema)
///
...
/// **WorkflowCommandPort**(命令端口)
///
/// 来源: docs/api-design.md §3.13 (Workflow Definition + Transition)
///
...
/// Domain Event: `star.events.workflow.workflow.created.v1`
///
/// 来源: docs/api-design.md §5 (CloudEvents 1.0)
///
/// **骨架阶段**: 仅占位字段,Phase 2 补充完整 Payload 字段。
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Workflow01Event {
    /// 事件唯一 ID(UUIDv7)
    pub event_id: Uuid,
    /// 租户 ID(必带)
    pub tenant_id: Uuid,
...
/// Domain Event: `star.events.workflow.workflow.updated.v1`
///
/// 来源: docs/api-design.md §5 (CloudEvents 1.0)
///
/// **骨架阶段**: 仅占位字段,Phase 2 补充完整 Payload 字段。
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Workflow02Event {
    /// 事件唯一 ID(UUIDv7)
    pub event_id: Uuid,
    /// 租户 ID(必带)
    pub tenant_id: Uuid,
