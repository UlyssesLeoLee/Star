...
import { Calendar, TrendingDown, Flag, Target, CalendarRange } from "lucide-react";
...
export default function PlanningPage() {
  ...
  // eventId 形如 "ms-001" / "wi-007" / "spr-001", 根据 kind 调不同 action
  // (W3 minimal data layer: 顶层 page 知道怎么 dispatch 到 store)
  const handleEventMove = (eventId: string, newDate: string) => {
    ...
    // sprint 区间拖动暂时走 updateSprintDates (本视图暂未启用)
  };
  ...
  return (
    <div className="max-w-7xl">
      <PageHeader
        title="Planning"
        subtitle="Sprint / Milestone / Burndown / Calendar — 四件套. Calendar 拖 work-item 改 due_date, 拖 milestone 改 due_date (per dynamic-interaction-design.md §5)"
