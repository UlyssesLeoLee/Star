...
export const agentSessions: AgentSession[] = [
  { id: "ag-001", name: "Agent ag-001", tenant_id: TENANT_ID, project_id: PROJECT_ID, worktree_id: "wt-001", agent_kind: "claude-sonnet", status: "completed",          current_step: "validation.pass",       token_usage: { input: 124_000, output: 38_000, total: 162_000 }, cost_summary: { usd: 0.92,  budget_usd: 5.0 }, started_at: ago(60 * 35), ended_at: ago(60 * 30) },
  { id: "ag-002", name: "Agent ag-002", tenant_id: TENANT_ID, project_id: PROJECT_ID, worktree_id: "wt-002", agent_kind: "codex",          status: "completed",          current_step: "validation.pass",       token_usage: { input: 168_000, output: 51_000, total: 219_000 }, cost_summary: { usd: 1.18,  budget_usd: 5.0 }, started_at: ago(60 * 30), ended_at: ago(60 * 24) },
  { id: "ag-003", name: "Agent ag-003", tenant_id: TENANT_ID, project_id: PROJECT_ID, worktree_id: "wt-003", agent_kind: "claude-sonnet", status: "awaiting_human",     current_step: "human.decision.required", token_usage: { input: 245_000, output: 72_000, total: 317_000 }, cost_summary: { usd: 1.81,  budget_usd: 3.0 }, started_at: ago(60 * 5) },
  { id: "ag-004", name: "Agent ag-004", tenant_id: TENANT_ID, project_id: PROJECT_ID, worktree_id: "wt-004", agent_kind: "codex",          status: "completed",          current_step: "validation.pass",       token_usage: { input: 132_000, output: 41_000, total: 173_000 }, cost_summary: { usd: 0.97,  budget_usd: 5.0 }, started_at: ago(60 * 38), ended_at: ago(60 * 35) },
  { id: "ag-005", name: "Agent ag-005", tenant_id: TENANT_ID, project_id: PROJECT_ID, worktree_id: "wt-005", agent_kind: "claude-sonnet", status: "executing",          current_step: "tool.call:grep",        token_usage: { input: 89_000,  output: 22_000, total: 111_000 }, cost_summary: { usd: 0.62,  budget_usd: 5.0 }, started_at: ago(60 * 0.6) },
  { id: "ag-006", name: "Agent ag-006", tenant_id: TENANT_ID, project_id: "prj-stargate", worktree_id: "wt-006", agent_kind: "codex",      status: "validating",         current_step: "test:e2e:realtime",     token_usage: { input: 67_000,  output: 18_000, total: 85_000 },  cost_summary: { usd: 0.48,  budget_usd: 2.0 }, started_at: ago(60 * 0.4) },
  { id: "ag-007", name: "Agent ag-007", tenant_id: TENANT_ID, project_id: "prj-stargate", worktree_id: "wt-007", agent_kind: "claude-sonnet", status: "compiling_context", current_step: "context.fetch:p2",      token_usage: { input: 23_000,  output: 5_000,  total: 28_000 },  cost_summary: { usd: 0.16,  budget_usd: 2.0 }, started_at: ago(60 * 0.1) },
  { id: "ag-008", name: "Agent ag-008", tenant_id: TENANT_ID, project_id: "prj-mobile", worktree_id: "wt-008", agent_kind: "codex",          status: "planning",            current_step: "plan.step:3/8",         token_usage: { input: 41_000,  output: 9_000,  total: 50_000 },  cost_summary: { usd: 0.28,  budget_usd: 2.0 }, started_at: ago(60 * 0.3) },
  { id: "ag-009", name: "Agent ag-009", tenant_id: TENANT_ID, project_id: PROJECT_ID, worktree_id: "wt-009", agent_kind: "claude-sonnet", status: "failed",              current_step: "validation.fail:INV-FB-02", token_usage: { input: 88_000, output: 12_000, total: 100_000 }, cost_summary: { usd: 0.51, budget_usd: 3.0 }, started_at: ago(60 * 22), ended_at: ago(60 * 20) },
  { id: "ag-010", name: "Agent ag-010", tenant_id: TENANT_ID, project_id: PROJECT_ID, worktree_id: "wt-010", agent_kind: "codex",          status: "completed",          current_step: "revert.applied",        token_usage: { input: 73_000,  output: 19_000, total: 92_000 },  cost_summary: { usd: 0.49,  budget_usd: 2.0 }, started_at: ago(60 * 18), ended_at: ago(60 * 16) },
  { id: "ag-011", name: "Agent ag-011", tenant_id: TENANT_ID, project_id: PROJECT_ID, worktree_id: "wt-011", agent_kind: "claude-sonnet", status: "completed",          current_step: "validation.pass",       token_usage: { input: 156_000, output: 44_000, total: 200_000 }, cost_summary: { usd: 1.05,  budget_usd: 5.0 }, started_at: ago(60 * 25), ended_at: ago(60 * 22) },
  { id: "ag-012", name: "Agent ag-012", tenant_id: TENANT_ID, project_id: PROJECT_ID, worktree_id: "wt-012", agent_kind: "codex",          status: "awaiting_feedback",  current_step: "feedback.request",      token_usage: { input: 112_000, output: 33_000, total: 145_000 }, cost_summary: { usd: 0.79,  budget_usd: 5.0 }, started_at: ago(60 * 0.5) },
];
