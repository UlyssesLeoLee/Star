...
export const CATEGORY_STYLES: Record<ModuleCategory, CategoryStyle> = {
  ...
  // Per 2026-09-02 16:13 JST 视觉走查 v2: bg /15→/20, text 800→900
  // 解决 low-alpha 大色块下 amber/cyan 视觉撞色, 强化全 5 域 hue 排开
  core: {
    bg: "bg-cyan-500/20 dark:bg-cyan-400/20",
    bgActive: "bg-cyan-500/30 dark:bg-cyan-400/30",
    text: "text-cyan-900 dark:text-cyan-200",
    border: "border-cyan-500/50 dark:border-cyan-400/50",
    borderActive: "border-cyan-500/80 dark:border-cyan-400/80",
    glow: "shadow-[0_0_12px_rgba(34,211,238,0.45)]",
    dot: "bg-cyan-500 dark:bg-cyan-400",
    name: "Core",
  },
  // Work — blue (Jira Software 蓝, 用 blue-500 跟 core cyan-500 区分明显)
  work: {
    bg: "bg-blue-500/20 dark:bg-blue-400/20",
    bgActive: "bg-blue-500/30 dark:bg-blue-400/30",
    text: "text-blue-900 dark:text-blue-200",
    border: "border-blue-500/50 dark:border-blue-400/50",
    borderActive: "border-blue-500/80 dark:border-blue-400/80",
  ...
  agent: {
    ...
    bgActive: "bg-emerald-500/30 dark:bg-emerald-400/30",
    text: "text-emerald-900 dark:text-emerald-200",
    border: "border-emerald-500/50 dark:border-emerald-400/50",
    borderActive: "border-emerald-500/80 dark:border-emerald-400/80",
  ...
  integration: {
    ...
    bgActive: "bg-violet-500/30 dark:bg-violet-400/30",
    text: "text-violet-900 dark:text-violet-200",
    border: "border-violet-500/50 dark:border-violet-400/50",
    borderActive: "border-violet-500/80 dark:border-violet-400/80",
    glow: "shadow-[0_0_12px_rgba(167,139,250,0.45)]",
    dot: "bg-violet-500 dark:bg-violet-400",
    name: "Integration",
  },
  // System — amber (Jira 警示橙 #FF8B00, 提到 /20 避免跟 cyan 撞色)
  system: {
    bg: "bg-amber-500/20 dark:bg-amber-400/20",
    bgActive: "bg-amber-500/30 dark:bg-amber-400/30",
    text: "text-amber-900 dark:text-amber-200",
    border: "border-amber-500/50 dark:border-amber-400/50",
    borderActive: "border-amber-500/80 dark:border-amber-400/80",
...
export const ALL_MODULES: ModuleDefinition[] = [
  ...
  },
  {
    ...
    code: "03",
    href: "/projects",
    // Per 2026-09-02 16:13 JST 域分色: Projects 是项目工作区, 归 work 域
    category: "work",
    categoryLabel: "Core Workspace",
  ...
  },
  {
    ...
    code: "04",
    href: "/agents",
    // Per 2026-09-02 16:13 JST 域分色: Agents 是智能 agent 编排, 归 agent 域
    category: "agent",
    categoryLabel: "Core Workspace",
  ...
  },
  {
    ...
    code: "05",
    href: "/analytics",
    // Per 2026-09-02 16:13 JST 域分色: Analytics 是工程效能, 归 work 域
    category: "work",
    categoryLabel: "Core Workspace",
  ...
  },
  {
    ...
    code: "06",
    href: "/settings",
    // Per 2026-09-02 16:13 JST 域分色: Settings 是系统级配置, 归 system 域
    category: "system",
    categoryLabel: "Core Workspace",
  ...
  },
  {
    ...
    code: "M",
    href: "/remote",
    // Per 2026-09-02 16:13 JST 域分色: Remote 是手机端连接, 归 system 域
    category: "system",
    categoryLabel: "Core Workspace",
