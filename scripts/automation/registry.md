...
| srs-canvas-agent-001 | `docs/briefs/srs-canvas-agent-001.md` v1.1 | `docs/requirements/SRS-CANVAS-AGENT-001.md` v1.1 (105,733 bytes, 1,558 行) | — | P3-D.5.1 无限画布双核心之 1: agent 管理 38 项 (28 旧 A1-A10 + 10 新 A11 ARG 图论构造), 引用 SRS-AGENT-RELATIONSHIP-001 v0.1 主源 109 次 + 13 段 IPA SEC 模板 + 7 张表 W/T/M 100% 覆盖 + 守门 14/14 通过 |
