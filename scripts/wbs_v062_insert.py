"""v0.62 WBS row insertion (per 守门 #12 commit-time docs sync, v29 第 51 次新事件触发)

Inserts v0.62 row after v0.61 in STAR-P3-WBS-001.md (幂等).
...
def main():
    ...
    if "v0.62-v14v4-mavis-audit" in content:
