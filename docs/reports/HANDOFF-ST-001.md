...
### 18.6 3 待续做项 (推下 session 列表, per §5.3 缺标比错标, G-TMO-05 + G-TMO-04 + G-TMO-04b 已关闭)
...
| ~~G-TMO-04b~~ | ~~metadata_node 集成 task_metadata DDL (in-memory → SQLite 持久化)~~ | **🟢 关闭** (per G-TMO-04b-REPO-IMPL-REPORT v0.1, 4 API + 14/14 e2e pass + DDL UNIQUE 修订) | closed |
