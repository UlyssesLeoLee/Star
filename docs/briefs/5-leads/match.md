# match-lead Subagent Brief (per 守门 #14 5 域 Lead CONTENT 4 维)

## 任务
match 域 (对战域) Lead 决策. 覆盖: 匹配 / 房间 / 对战逻辑 / 战报 / 跨域协调.

## 上下文
- 5 域 (player / economy / match / social / admin) 是历史治理命名 (per AGENTS.md §5)
- 22 domain-* crate 跟 5 域不建立业务子域↔DDD 映射 (per 守门 §5 disclaimer)
- 决策 scope: match 域内所有技术决策
- 跨域关联: 战报推送 (match→social) + 战斗奖励 (match↔economy)
