...
> **依赖**：[ADR-0026 STAR AI Compat](0026-star-ai-compat.md) · [spec/flows/01-agent-task-lifecycle.md](../architecture/2026-08-26-upgrade/spec/flows/01-agent-task-lifecycle.md) · [spec/agent-api/01-schema.md §3.17 Resume](../architecture/2026-08-26-upgrade/spec/agent-api/01-schema.md)
> **关联**：[flows/02 Agent Lease/Heartbeat](../architecture/2026-08-26-upgrade/spec/flows/02-agent-lease-heartbeat.md) · [flows/03 Agent Resume](../architecture/2026-08-26-upgrade/spec/flows/03-agent-resume.md)
