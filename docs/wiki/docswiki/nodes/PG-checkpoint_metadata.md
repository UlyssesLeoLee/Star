---
id: PG-checkpoint_metadata
title: checkpoint_metadata (M)
date: 2026-09-06
source: 'S7 §3.2 L81'
...
supersedes: null
in-topology: ["PG-checkpoint_metadata"]
guards:
  - id: '#1'
    name: 0 unsafe + 0 err
...
Master (SCD Type 2), 物理删除禁止, valid_from/valid_to, RLS 13 類必携
