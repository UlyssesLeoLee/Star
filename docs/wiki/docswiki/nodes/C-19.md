...
layer: orchestration
view: LangGraph
related: ["PG-checkpoint_metadata", "C-07-TaskCardManager"]
see-also: ["M-23"]
version: 0.1
revision: '['C-19', '00-design-topology', '02-orchestration-langgraph']'
supersedes: null
in-topology: ["C-19"]
guards:
  - id: '#1'
...
★ task_metadata 表中央管理 (Master RLS 必携 per 守门 #13 c)
