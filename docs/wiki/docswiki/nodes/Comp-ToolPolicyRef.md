...
layer: runtime
view: AgentRuntime
related: ["Tool Registry"]
see-also: ["Tool Registry"]
version: 0.1
revision: '['03-runtime-ecs']'
supersedes: null
in-topology: ["Comp-ToolPolicyRef"]
guards:
  - id: '#1'
    name: 0 unsafe + 0 err
...
# Comp-ToolPolicyRef — ToolPolicyRef
