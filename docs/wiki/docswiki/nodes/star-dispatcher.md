...
date: 2026-09-06
source: 'crates/star-dispatcher/src/'
...
# star-dispatcher — star-dispatcher
...
L0 派发 (per S4 §3.1, enqueue/get/list/transition/submit API), 5 src 文件

**文档来源**: crates/star-dispatcher/src/
