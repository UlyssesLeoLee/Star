...
layer: orchestration
view: LangGraph
related: ["M-N1", "M-N2", "M-N3", "M-N4", "M-N5", "M-N6", "M-N7"]
see-also: ["M-19"]
version: 0.1
revision: '['C-16', '00-design-topology', '02-orchestration-langgraph']'
supersedes: null
in-topology: ["C-16"]
guards:
  - id: '#1'
...
★ TMO 集中管理: 7 节点 (M-N1..M-N7) + 7 协议 + DAG 校验; 唯一 cross-task actor
