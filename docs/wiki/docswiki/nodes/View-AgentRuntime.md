---
id: View-AgentRuntime
title: Agent Runtime view
date: 2026-09-06
source: 'S4 §1.3 L56-67'
status: design-baseline
classification: -
importance: P0
layer: runtime
view: AgentRuntime
related: ["22 domain crates", "View-LangGraph"]
see-also: []
version: 0.1
revision: '['00-design-topology']'
supersedes: null
in-topology: ["View-AgentRuntime"]
guards:
  - id: '#1'
    name: 0 unsafe + 0 err
...
# View-AgentRuntime — Agent Runtime view
...
Rust 大规模并发 Runtime 基础设施 (派发 + ECS + 共享池)
