...
layer: orchestration
view: LangGraph
related: ["C-20-DAGValidator", "C-16-TaskOperationsManager"]
see-also: ["M-20"]
version: 0.1
revision: '['C-17', '00-design-topology', '02-orchestration-langgraph']'
supersedes: null
in-topology: ["C-17"]
guards:
  - id: '#1'
...
★ 任务卡 DAG (parent_task_id / merged_from / split_into / superseded_by 4 字段), cycle prevention
