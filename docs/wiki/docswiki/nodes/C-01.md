...
layer: orchestration
view: LangGraph
related: ["T-N1", "T-N2", "T-N3", "T-N4", "T-N5", "T-N6", "T-N7", "C-02-SubAgentPool", "C-04-CheckpointStore"]
see-also: ["M-01", "M-02"]
version: 0.1
revision: '['C-01', '00-design-topology', '02-orchestration-langgraph']'
supersedes: null
in-topology: ["C-01"]
guards:
  - id: '#1'
...
L0 全体代理 LangGraph instance, 意图解析/dispatch/collect/respond
