...
layer: orchestration
view: Cross
related: ["PG-checkpoints", "PG-checkpoint_writes", "PG-checkpoint_metadata"]
see-also: ["M-08"]
version: 0.1
revision: '['C-04', '00-design-topology', '02-orchestration-langgraph']'
supersedes: null
in-topology: ["C-04"]
guards:
  - id: '#1'
...
> **节点类型**: orchestration / Cross
> **重要度**: P0
> **守门分类**: -

## 1. 描述

3-tier 永続化 (Memory / SQLite / PostgreSQL)
