...
title: bulk_node
date: 2026-09-06
source: 'S2 §2.6.1 L515'
status: design-baseline
classification: T (Transaction - audit log)
importance: P0
layer: orchestration
view: LangGraph
related: ["TaskOperationsManager", "C-16"]
see-also: ["C-17-TaskRelationshipGraph", "C-20-DAGValidator"]
version: 0.1
revision: '['02-orchestration-langgraph', '05-persistence-checkpoint', '06-data-flow']'
supersedes: null
in-topology: ["M-N4"]
guards:
  - id: '#1'
...
> **重要度**: P0
> **守门分类**: T (Transaction - audit log)

## 1. 描述

N 张卡批量 action (pause/resume/cancel/set_priority), asyncio.gather + 部分失败回滚
...
| #11 缺标比错标 | 已知缺口显式列 |
| #12 AI 協作文档治理 | 0 回溯叙事 |
| #13 DB W/T/M | 守门 #13 (本节点 = T (Transaction - audit log)) |
