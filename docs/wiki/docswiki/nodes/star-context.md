...
title: star-context
date: 2026-09-06
source: 'crates/star-context/src/'
...
ActorContext (per H2 star_context 9/3 P0-1), 3 src 文件

**文档来源**: crates/star-context/src/
