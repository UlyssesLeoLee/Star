...
date: 2026-09-06
source: 'crates/star-treesitter/src/'
...
# star-treesitter — star-treesitter
...
Tree-sitter (per 2026-09-03 treesitter-worktree-graph view), 4 src 文件

**文档来源**: crates/star-treesitter/src/
