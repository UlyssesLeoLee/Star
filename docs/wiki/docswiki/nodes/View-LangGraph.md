...
layer: orchestration
view: LangGraph
related: ["View-AgentRuntime", "View-AgentView"]
see-also: []
version: 0.1
revision: '['00-design-topology']'
supersedes: null
in-topology: ["View-LangGraph"]
guards:
  - id: '#1'
    name: 0 unsafe + 0 err
...
UI 驱动的 2-level hierarchical Agent (L0 + L1 任务卡子代理), LangGraph Python subgraph
