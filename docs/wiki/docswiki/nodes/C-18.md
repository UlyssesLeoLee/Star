...
layer: orchestration
view: LangGraph
related: ["C-16-TaskOperationsManager", "C-02-SubAgentPool"]
see-also: ["M-21"]
version: 0.1
revision: '['C-18', '00-design-topology', '02-orchestration-langgraph']'
supersedes: null
in-topology: ["C-18"]
guards:
  - id: '#1'
...
★ bulk_action 队列 + asyncio.gather 协调, 部分失败回滚
