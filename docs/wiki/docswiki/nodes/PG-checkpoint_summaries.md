---
id: PG-checkpoint_summaries
title: checkpoint_summaries (T)
date: 2026-09-06
source: 'S7 §3.2 L80'
...
supersedes: null
in-topology: ["PG-checkpoint_summaries"]
guards:
  - id: '#1'
    name: 0 unsafe + 0 err
...
# PG-checkpoint_summaries — checkpoint_summaries (T)
...
Transaction (append-only), 物理删除禁止, RLS 13 類必携
