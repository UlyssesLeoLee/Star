...
| v0.2 | 2026-09-10 | Ulysses（一人公司 12 角色 per DEC-008）— Mavis 接手**审核** (反转, 不是代签) | 政策全部取消: 真人代签流程全部取消, 改为 mavis 审核; 替代政策详见 v32 候选; AGENTS.md 守门 #14 v3 → v4 反转; v0.62 修订历史 row 显式标反转 (per守门 #1 禁回溯叙事) | 2026-09-10 12:45 JST Ulysses 发令"真人代签流程全部取消, 改为 mavis 审核" (per 9/8 15:19 第 6 次强化 Mavis 全权代理 + 9/8 15:29 第 7 次强化 Mavis 自驱) |
