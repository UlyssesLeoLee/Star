...
> **Multica Hook 域基本設計書 v0.1** (per 日本 IPA SEC 標準 / 基本設計書 テンプレート)
...
> - 上位要件: [`docs/requirements/SRS-MULTICA-HOOK-001.md`](../requirements/SRS-MULTICA-HOOK-001.md) v0.1 (32KB, 8 機能 / 5 業務 / 6 非機能 / 8 验收 / 8 已知缺口, 守门 8/8 通过)
...
│  │  │ └ Skills 标签页   │ │ └ Hooks 标签页    │ │ └ (预留)       │    │  │
│  │  │   (per skill SRS)│ │   (本 BD §3)     │ │   Commands    │    │  │
│  │  └──────────────────┘ └──────────────────┘ └───────────────┘    │  │
│  └─────────────────────────────────────────────────────────────────┘  │
│                                  ▲                                   │
